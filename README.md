...
│                         stock_predictor and configuration for tools like black
│
...
│
└── stock_predictor   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes stock_predictor a Python module
    │
